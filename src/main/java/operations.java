...
public class operations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.println("<head><title>Crop Management</title>");
		...
		out.println("<a class=\"btn btn-dark\" href=\"addbooks.html\" role=\"button\">Add Crops</a>");
		out.println("<a class=\"btn btn-dark\" href=\"delete.html\" role=\"button\">Deleat Crops</a>");
		out.println("<a class=\"btn btn-dark\" href=\"update.html\" role=\"button\">Update Crops</a>");
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
